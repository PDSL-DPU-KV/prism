...
WORKLOAD_TYPE=(a b c d e f)   #Typing which workload_type will be tested.
CORE_NUM=(20)		    #how many CPU cores?    ##PRISM threads: CPU cores / 5 * 4 ##IO Completion threads: CPU cores * 5
